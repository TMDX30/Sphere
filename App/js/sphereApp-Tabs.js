...
sphereApp.onPageInit('index-scroll-tabs', function(page) {
    ...
    $$('#tab-1').on('show', function() {
        ...
        var allList = sphereApp.virtualList($$(page.container).find('.all-list'), {
    ...
    $$('#tab-2').on('show', function() {
        ...
        var newStarterList = sphereApp.virtualList($$(page.container).find('.newstarter-list'), {
        ...
        // ###### Push to all items array IF UNIQUE ###### //
        ...
        // function //
        Array.prototype.pushIfNotExist = function(newStarterList, comparer) {
            if (!this.inArray(comparer)) {
                this.push(newStarterList);
            }
        };

        // Sets up categories to compare //
        // funciton //
        allItems.pushIfNotExist(newStarterList, function(e) {
            return e.category === newStarterList.category && e.picture === newStarterList.picture && e.title === newStarterList.title && e.subHeading === newStarterList.subHeading && e.description === newStarterList.description && e.link === newStarterList.link;
        });

        console.log(allItems);

    });
    // New Starter List End //

    // Working Here List //
    $$('#tab-3').on('show', function() {
        var workingHereList = sphereApp.virtualList($$(page.container).find('.workinghere-list'), {
        ...
        // Adds an element to the array if it does not already exist using a comparer //
        // function //
        Array.prototype.pushIfNotExist = function(workingHereList, comparer) {
            if (!this.inArray(comparer)) {
                this.push(workingHereList);
            }
        };

        // Sets up categories to compare //
        // funciton //
        allItems.pushIfNotExist(workingHereList, function(e) {
            return e.category === workingHereList.category && e.picture === workingHereList.picture && e.title === workingHereList.title && e.subHeading === workingHereList.subHeading && e.description === workingHereList.description && e.link === workingHereList.link;
        });

        console.log(allItems);

    });
    // Working Here List End //

    // Travel List //
    $$('#tab-4').on('show', function() {
        var travelList = sphereApp.virtualList($$(page.container).find('.travel-list'), {
        ...
        // Adds an element to the array if it does not already exist using a comparer //
        // function //
        Array.prototype.pushIfNotExist = function(travelList, comparer) {
            if (!this.inArray(comparer)) {
                this.push(travelList);
            }
        };

        // Sets up categories to compare //
        // funciton //
        allItems.pushIfNotExist(travelList, function(e) {
            return e.category === travelList.category && e.picture === travelList.picture && e.title === travelList.title && e.subHeading === travelList.subHeading && e.description === travelList.description && e.link === travelList.link;
        });
